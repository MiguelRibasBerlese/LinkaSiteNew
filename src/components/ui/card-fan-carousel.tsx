  ...
  return (
    <section className="flex flex-col items-center w-full py-4 lg:py-8 px-4 md:px-8 relative z-20">
      <div className="flex items-center justify-center w-full max-w-[90rem]">
        <div ref={containerRef} className="fan-layout flex relative justify-center items-center w-full max-w-[80rem] h-56 sm:h-72 md:h-[22rem]">
          {cards.map((card, index) => {
            ...
            return card.linkUrl ? (
              ...
              <div key={index} className={fanClasses}>{image}</div>
            );
          })}
        </div>
      </div>
